...
const slides = [
  {
    ...
    video: "https://ship-crm-img.s3.eu-north-1.amazonaws.com/happy-family-tiny-newborn-infant-male-or-female.mp4", // need to change link
  },
  {
          ...
          <SwiperSlide key={index}>
            <div className="relative w-full h-[90vh]">
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(to right, rgba(43,57,144,1) 20%, rgba(43,57,144,0.2) 100%)",
                }}
              />

              {/* 🔹 Text Content */}
              <div className="absolute z-10 top-1/2 -translate-y-1/2 text-white max-w-xl">
                <div className="pl-8 md:pl-20">
                  ...
                  <p className="text-[16px] mb-6 text-[#fff]">{slide.description}</p>
      ...
      <div className="absolute bottom-0 left-0 w-full px-16 py-6 z-50">
        <div className="flex justify-between text-white text-sm font-medium">
          {slides.map((slide, index) => (
            <div
              key={index}
              className="cursor-pointer flex-shrink-0 w-1/4 ml-4"
