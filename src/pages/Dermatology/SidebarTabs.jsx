...
const accordionData = [
  ...
  },
  {
    ...
    content: (
      <div className="text-sm  space-y-3">
        <p>
          Our dermatologists manage chronic skin conditions like psoriasis and eczema with a balanced approach that includes lifestyle counselling, medication, and advanced therapies. We aim to reduce flare-ups and improve quality of life.
        </p>
      ...
      <aside className="w-full lg:w-1/3 lg:sticky top-24 h-fit space-y-6">
        ...
        >
          ...
          <ul className="space-y-4 text-start mt-4">
            <li className="flex items-start  gap-1 text-[14px] font-semibold">  <Image className="mt-1" src={Checklight} alt="tick" width={12} height={10} />Expert dermatologists for both medical and cosmetic concerns.</li>
            <li className="flex items-start  gap-1 text-[14px] font-semibold">  <Image className="mt-1" src={Checklight} alt="tick" width={12} height={10} />Safe and effective skin rejuvenation and anti-aging solutions.</li>
            <li className="flex items-start  gap-1 text-[14px] font-semibold">  <Image className="mt-1" src={Checklight} alt="tick" width={12} height={10} />Personalized treatment plans for chronic and recurring skin issues.</li>
          </ul>
          ...
          <section key={id} id={id} className="scroll-mt-32 rounded-xl">
              ...
              <>
                <div className=" space-y-4">
                  ...
                  <h2 className="text-[24px]">
                    Dermatology Services and Skin Treatments at  <span className="text-[#2B3990]"> Sudha </span>  Multispeciality Hospital
                  </h2>
                  <p className="mb-4">
                    The Dermatology Department at Sudha Multispeciality Hospital provides expert diagnosis and advanced treatment for a wide spectrum of skin, hair, and nail conditions. Our team of skilled dermatologists combines clinical excellence with the latest technology to deliver comprehensive care for both medical and cosmetic concerns. Whether managing chronic skin disorders or offering aesthetic solutions, we ensure patient-centred care with an emphasis on long-term skin health.
                  </p>
                </div>
              </>
            )}
            ...
            {id === "treatmentsandprocedures" && (
              <div className="space-y-2">
                <h2 className="text-[24px] mt-5 mb-3">Treatments and Procedures</h2>
