            ...
            {id === "overview" && (
              <>
                <Image src={aboutOverview} alt="aboutOverview" className="w-full h-[400px] rounded-2xl object-cover" />
                  ...
                  Best Paediatric and Neonatal Care in <span className="text-[#2B3990]"> Erode</span>  at Sudha Multispeciality Hospital
                </h2>
                <p className="mb-3">
                  Sudha Multispeciality Hospital’s Paediatrics Department is built on clinical excellence, advanced infrastructure, and round-the-clock specialist support. From neonatal care to paediatric emergencies, our dedicated team of paediatricians, intensivists, and trained nursing staff provide expert care. With dedicated NICU and PICU units, emergency response systems, and child-friendly facilities, we are equipped to handle a wide spectrum of paediatric conditions, ensuring timely, compassionate, and evidence-based treatment for every child.
                </p>
              ...
              <>
                ...
                <ul>
                  <li className="flex gap-2 items-center text-[#5E566A] text-[15px] font-semibold mt-3">
                    <div className="w-2 h-2 rounded-lg bg-[#2B3990]"></div> 24x7 Emergency Services for paediatric and neonatal emergencies </li>
                  <li className="flex gap-2 items-center text-[#5E566A] text-[15px] font-semibold mt-3">
