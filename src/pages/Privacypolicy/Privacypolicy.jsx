    ...
    return (
        <div>
            ...
            <div className="max-w-7xl mx-auto px-4 py-10 text-gray-700 text-base leading-relaxed " >
                <h1 className='text-[#000000] font-bold text-2xl pb-2 pt-8'>Sudha Hospitals is located at:</h1>
                ...
                <h1 className='text-[#000000] font-bold text-2xl pb-2 pt-6'>Website Visitors</h1>
                <p className='pt-2'>
                ...
                <h1 className='text-[#000000] font-bold text-2xl pb-2 pt-6'>Gathering of Personally-Identifying Information</h1>
                <p className='pt-2'>
                ...
                <h1 className='text-[#000000] font-bold text-2xl pb-2 pt-6'>Security</h1>
                <p className='pt-2'>
                ...
                <h1 className='text-[#000000] font-bold text-2xl pb-2 pt-6'> Advertisements</h1>
                <p className='pt-2 '>
                ...
                <h1 className='text-[#000000] font-bold text-2xl pb-2 pt-6'> Links To External Sites</h1>
                <p className='pt-2 '>
                ...
                <h1 className='text-[#000000] font-bold text-2xl pb-2 pt-6'>Sudha Hospitals uses Google AdWords for remarketing</h1>
                <p className='pt-2 '>
                ...
                <h1 className='text-[#000000] font-bold text-2xl pb-2 pt-6'>Aggregated Statistics</h1>
                <p className='pt-2 '>
                ...
                <h1 className='text-[#000000] font-bold text-2xl pb-2 pt-6'>Cookies</h1>
                <p className='pt-2 '>
                ...
                <h1 className='text-[#000000] font-bold text-2xl pb-2 pt-6'>Privacy Policy Changes</h1>
                <p className='pt-2 '>
                ...
                <h1 className='text-[#000000] font-bold text-2xl pb-2 pt-6'>Credit & Contact Information</h1>
